...
Alcance sugerido inmediato: consumir `GET/POST /api/work-orders/{workOrderId}/delivery` y `/api/deliveries/*` desde `/app/ordenes/:id`, crear/asignar entrega, registrar salida y mostrar estado logístico. Fuente: `docs/01-product/delivery-mvp-design.md`.
