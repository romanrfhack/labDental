...
1. Implementar Fase 3.5.2: UI admin catálogo/precios con selección de imagen existente.
2. Después implementar Fase 3.5.3: `/catalogo` público consume `GET /api/catalog/public` con transición controlada.
