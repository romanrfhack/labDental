...
1. Validar Fase 3.5.2 en DEV con Admin y usuario de solo lectura `catalog.view`.
2. Implementar Fase 3.5.3: `/catalogo` público consume `GET /api/catalog/public` con transición controlada.
